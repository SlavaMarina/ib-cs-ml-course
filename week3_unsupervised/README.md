# Week 3: Unsupervised Learning + Model Selection

## 📋 Syllabus statements

- **`A4.3.4`** — Clustering algorithms
- **`A4.3.5`** — Association rule learning
- **`A4.3.10`** — Model selection

## 🎯 Topics

K-means, DBSCAN, hierarchical and spectral clustering, association rule learning (Apriori), support / confidence / lift, model selection, cross-validation.
...
Clustering, K-means, Centroid, DBSCAN, Apriori, Support, Confidence, Lift, Silhouette score, Model selection.
